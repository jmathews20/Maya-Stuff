...
//Name: Old Book.ma
//Last modified: Sun, Dec 06, 2015 11:13:01 AM
//Codeset: 1252
requires maya "2016";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -7.0752553775444795 3.6775287007516866 -7.6411503733271253 ;
	setAttr ".r" -type "double3" -18.938352729044038 579.39999999998304 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "FCB442C8-4FC9-FC77-A858-72ACEEF918A9";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 10.828287113706178;
...
createNode transform -n "directionalLight1";
	rename -uid "64C32A41-41DA-F43F-1A1B-43B6ABC8E90B";
	setAttr ".t" -type "double3" -4.7358756129249429 6.0446315043255883 -2.6452374264954006 ;
	setAttr ".r" -type "double3" -113.42248662815511 -3.656565718035389 53.133795423502058 ;
createNode directionalLight -n "directionalLightShape1" -p "directionalLight1";
	rename -uid "B36F13DF-4843-23EC-F316-0A909D05E2F2";
	setAttr -k off ".v";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "D109ADB4-47E3-D93F-C124-458166A4A956";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "9C161EFB-4C14-8583-8C39-8B9224E1F78B";
createNode displayLayer -n "defaultLayer";
	rename -uid "05ABAE78-4B64-56F6-8D04-2D86A6594A91";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "1EDDCFEB-4F9C-5346-6AA9-27AFB867579B";
